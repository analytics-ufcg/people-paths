...
```
  ...
  Observamos agora as rotas para as quais as viagens inferidas dos usuários foram maiores no quesito distância. A rota 474 apresenta uma distância consideravalmente maior nas suas viagens no período de terça, quarta e quinta. A mesma liga regiões afastadas, como o bairro Uberaba, ao centro da cidade. Outra rota de comportamento similar é a 617. Essa liga também regiões afastadas, como o bairro Tutuquara, mas a bairros comerciais, como Capão Raso e Pinheirinho.
  Por outro lado, apresentando um comportamento contrário, ou seja, tendo a distância consideravelmente maior no período de segunda e sexta, a 646 liga uma bairro de características rurais a centros de comércio popular, como o bairro Pinheirinho.
...
```
  ...
  Para o horário da manhã, aquele que concentra a maior quantidade de viagens, são apenas três as rotas que aprensentam suas viagens mais longas nesse horário, a 659, 508 e 684.
