...
```{r}
wa.map <- readOGR("~/Downloads/DIVISA_DE_BAIRROS.shp")
...
sodo <- wa.map[wa.map$TIPO == "DIVISA DE BAIRROS", ]

dat <- data.frame(Longitude = c(-49.22511,-49.29225),
                  Latitude = c(-25.42891, -25.42102),
                  names = c("Safeco Field", "Key Arena"))

coordinates(dat) <- ~ Latitude + Longitude
