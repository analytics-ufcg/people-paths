...
ggplot(mapdata, aes(x=x, y=y)) + 
  ...
  geom_path(data=shpf,aes(x=long, y=lat,group=group), colour="grey50")+
...
ggplot() +  
    ...
    geom_density2d(aes(x=x, y=y), data=mapdata, alpha=1, size=3, color="grey20")+# to get outline
    geom_density2d(aes(x=x, y=y), data=mapdata, alpha=1, size=2)+
