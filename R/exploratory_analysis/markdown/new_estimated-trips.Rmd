...
ggplot(data1long, aes(x = reorder(route, -value_adjusted), y = value_adjusted)) + geom_col(stat='identity', fill="forest green") + facet_wrap(~measure) + labs(x = "route", y = "value")
...
data_comparation4 <- merge(x = seis_oito, y = onze_uma, by = "route")

data_comparation5 <- merge(x = data_comparation4, y = cinco_sete, by = "route")
data_comparation5
