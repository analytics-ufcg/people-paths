...
```
  ...
  O 90 percentil nos mostra que para a rota 506, suas viagens estão em 90% delas, abaixo ou igual a meia hora de viagem. Podemos ver que viagens mais curtas é uma caracterítica da rota, pois 90% de das viagens não passam de meia hora.
...
ggplot(dataPercLong, aes(x = reorder(route, -value), y = value)) + geom_col(stat='identity', fill="black") + facet_wrap(~measure) + labs(x = "route", y = "trip duration")
