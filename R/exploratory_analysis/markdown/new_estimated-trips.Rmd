...
9) Gráfico de dispersão para a diferença das viagens de segunda e sexta e terça a quinta. Popularidade, velocidade e distância.

```{r}

```

Distância e quantidade de viagens.
```{r}
day_group <- data.frame(week_day = c(2:6),
                        day_group = c("SS", "TQ", "TQ", "TQ", "SS"))
