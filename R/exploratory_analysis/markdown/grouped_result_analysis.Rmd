---
title: "Análise descritiva nos dados do transporte público de Curitiba-PR - dados de maio, junho e julho agrupados"
...
```{r}
grouped_result <- read_csv("/local/juninho/aggregate_output/output2/result.csv", col_types = list(
